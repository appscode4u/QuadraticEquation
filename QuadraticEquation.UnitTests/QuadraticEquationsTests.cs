...
namespace QuadraticEquation.UnitTests
{

    [TestFixture]
    [Author("maciej.zak@student.wsb.edu.pl")]
    [Category("QuadraticEquations Assert.AreEqual")]
    public class SquareEquationCalculatorTests
    {
        ...
        public void CalculateNumberOfRoots_ExpectedZeroRoots(double a, double b, double c, int expectedRootsCount)
        {
        ...
        [TestCase(1, -2, 1, 1)]
        [Description("This test proff counts of roots for diffrent cases")]
        public void CalculateNumberOfRoots_ExpectedOneRoot(double a, double b, double c, int expectedRootsCount)
        {
            var q = new QuadraticEquationCalculation();
            var result = q.CalculateNumberOfRoots(a, b, c);
        ...
        [Description("This test proff counts of roots for diffrent cases")]
        public void CalculateNumberOfRoots_ExpectedTwoRoots(double a, double b, double c, int expectedRootsCount)
        {
            var q = new QuadraticEquationCalculation();
            var result = q.CalculateNumberOfRoots(a, b, c);
